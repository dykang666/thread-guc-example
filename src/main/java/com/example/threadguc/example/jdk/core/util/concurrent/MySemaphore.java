package com.example.threadguc.example.jdk.core.util.concurrent;


import com.example.threadguc.example.jdk.core.util.locks.MyAbstractQueuedSynchronizer;
 ...
 * @author kangdongyang
 * @version 1.0
 * @description:  重写  Semaphore
 * @date 2024/9/18 12:43
 */
public class MySemaphore  implements Serializable {
    ...
    public void acquireUnInterruptibly() {
        mySync.tryReleaseShared(1);
    }
    public int availablePermits() {
        return mySync.getPermits();
    }
    public boolean release() {
        return mySync.tryReleaseShared(1);
    }
