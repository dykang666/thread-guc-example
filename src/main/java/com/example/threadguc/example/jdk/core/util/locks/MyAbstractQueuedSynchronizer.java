...
import com.example.threadguc.example.jdk.core.sun.misc.MyUnsafe;
 ...
 * @version 1.0
 * @description:  重写AQS
 *  https://github.com/lazypatient/Handwritten-jdk-source-code/blob/master/src/main/java/com/leaf/jdk/core/util/locks/MyReentrantLock.java
 * @date 2024/9/15 10:42
 */
...
/*
 ...
 head  | node |  next | node |       | node |  tail
       ...
       +------+       +------+       +------+
 */
public class MyAbstractQueuedSynchronizer implements java.io.Serializable{
